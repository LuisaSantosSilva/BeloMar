...
<body>
    ...
    include("navbar.php"); 
        ...
        $sqlDeletar = "DELETE FROM clientes WHERE id=" . $_SESSION['clientes'];
  
        // Executa o comando SQL
        $result = mysqli_query($conexao, $sqlDeletar);
        
        // Verifica se o comando foi executado com sucesso
        if(!$result)
          die("Falha ao executar o comando: " . mysqli_connect_error());
        else
